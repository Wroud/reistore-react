    ...
    render() {
        return (React.createElement(StoreProvider_1.StoreConsumer, null, store => (React.createElement(exports.Consumer, null, context => {
            ...
            return (React.createElement(exports.Provider, { value: this.selfContext },
                React.createElement(InnerComponent, Object.assign({}, this.lastData, props, { children: children }))));
        }))));
    }
    componentDidMount() {
...
function connect(store, map, innerComponent) {
    return (props) => (React.createElement(Connector, { schema: store, map: map, innerComponent: innerComponent, props: props }));
}
